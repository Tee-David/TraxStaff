...
import { IconBell, IconChart, IconClock, IconFlag, IconImage, IconMoon, IconSun, IconUser, IconUsers } from "@/components/icons";
...
/** One email a person can opt out of, as described by the server. */
interface EmailType {
  type: string;
  label: string;
  description: string;
