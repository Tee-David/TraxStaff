...
function LoginForm() {
  ...
  /**
   * Finish a Google sign-in: the credential is an ID token, and only the
   * backend can say whether it belongs to an account here — this route signs
   * existing members in and never creates accounts, so its refusals ("no
   * account for this address", "invite still pending") are worth showing
   * verbatim rather than flattening into "sign-in failed".
   */
